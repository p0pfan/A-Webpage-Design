...
CKEDITOR.plugins.add( 'table', {
	...
	init: function( editor ) {
		...
		editor.addCommand( 'table', new CKEDITOR.dialogCommand( 'table', {
			context: 'table',
			// font-size border-collapse allowed. --leiyang
			allowedContent: 'table{width,height,font-size,font-family,border-collapse,border}[align,border,cellpadding,cellspacing,summary];' +
				'caption tbody thead tfoot;' +
				'th td{background*,border*}; tr{background*}[scope];' +
